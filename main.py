...
parser.add_argument(
    "-p", "--plug", type=str, required=True, help="plug you want to modify"
)
parser.add_argument(
    "-l", "--lower-limit", type=int, default=30, help="battery lower limit"
)
parser.add_argument(
    "-u", "--upper-limit", type=int, default=80, help="battery upper limit"
)
